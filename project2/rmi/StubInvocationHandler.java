...
public class StubInvocationHandler implements InvocationHandler, Serializable {
    ...
    public Object invoke(Object proxy, Method method, Object[] arguments) throws Exception {
        ...
        if (method.getName().equals("toString") && !ifsf[1] &
            ...
            rmi.StubInvocationHandler r = (rmi.StubInvocationHandler)
        ...
        if (method.getName().equals("equals") && !ifsf[0] &
            ...
            rmi.StubInvocationHandler x = (rmi.StubInvocationHandler)
                    Proxy.getInvocationHandler(proxy);
            rmi.StubInvocationHandler y =
                    (rmi.StubInvocationHandler) Proxy.getInvocationHandler(b);
        ...
        try {
            ...
            rmi.requestObject reqo = new requestObject(method, arguments);
